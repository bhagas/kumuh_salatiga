<!-- BEGIN PAGE CONTENT  -->
        <div class="page-content page-wizard">
          <div class="header">
            <h2>Tambah <strong> Karakteristik kawasan</strong></h2>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                <li><a href="<?php echo base_url()?>">Home</a
                </li>
                <li class="active">Tambah Data Karakteristik kawasanv</li>
              </ol>
            </div>
          </div>
          <div class="row">
                ...
                <div class="panel-content">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <form role="form" role="form" method="post" action="<?php echo base_url('index.php/karakteristik_kawasan/submit') ?>" enctype="multipart/form-data">
